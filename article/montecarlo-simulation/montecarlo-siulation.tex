...
\acrodef{VMs}{Virtual machines}
\acrodef{PMs}{Physical machines}
...
provided  as  \ac{VMs},  happens  in  increment of  arbitrary  length  of  time,
...
\ac{VM}  are scheduled  and  the activity  of  your \emph{neighbors}.  \ac{IaaS}
operators attempt  to mask these  irregularities in computing power  and network
access by guaranteeing a minimum performance.
