...
%% Timeline
\node[strat]at(-5,0){Jobs \& Time};
\draw[-{latex},thick] (-5,0)--(95,0);
\foreach \x in {0,15,...,90}{%
\draw (\x-0.5,-1)--(\x-0.5,0.5) node[anchor=south]{\x};
}
%% Jobs
\node[job,minimum width=20mm,label={[]north:$j_1$}]at(0,0.2){};
\node[job,minimum width=80mm,label={[]south:$j_2$}]at(0,-0.2){};
\node[job,minimum width=30mm,label={[]east:$j_3$}]at(30,-0.6){};
\node[job,minimum width=20mm,label={[]north:$j_4$}]at(30,0.2){};
