...
\node[strat]at(-5,-1.2){Tasks};
\draw[-{latex},thick] (-5,0)--(95,0);
\foreach \x in {0,15,...,90}{%
\draw (\x-0.5,-0.5)--(\x-0.5,0.5) node[anchor=south]{\x};
}
%% Jobs
\node[job,minimum width=32mm]at(0,-0.5){$t_1$};
\node[job,minimum width=80mm]at(0,-1.3){$t_2$};
\node[job,minimum width=30mm]at(30,-2.1){$t_3$};
\node[job,minimum width=20mm]at(30,-2.9){$t_4$};
