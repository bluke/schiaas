...
\node[input]at(-2.5,2)(JD){Workload\\Description};
...
\node[minimum height=15mm,minimum width=25mm,align=center]at(1,0)(ck){Openstack\\API};
...
\node[minimum height=45mm+15pt,minimum width=50mm+10pt,label={[align=center]south:Broker\\Schlouder Server}]at(0.5,1)(ss){};
\node[minimum height=15mm,minimum width=25mm,align=center]at(3,0)(cc){Openstack\\Frontend};
