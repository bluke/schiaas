...
We used Schlouder to run scientific workloads on a private Openstack based
cloud. We used two workload of different application fields and of different
structures.
\begin{itemize}
	...
	\item OMSSA\cite{Geer2004}, the Open Mass-Spectrometry Search Algorithm, is
		used to analyse mass-spectrometer results. This workload is a
		Bag of Tasks with no job dependencies. This application is
...
To run the experiment with Schlouder a we set up a 96 core cloud based on four
identical dual $2.67GHz$ Intel Xeon X5650 servers with KVM based virtualisation
and an Openstack cloud-front (first 2012.1, and later 2014.2). This cluster was
exclusive to our usage and special attention was given to never overload the
system.
