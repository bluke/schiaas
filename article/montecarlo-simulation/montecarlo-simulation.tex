...
\textbf{FIXME:phrase suivante incorrecte/incompréhensible.} The models
...
a defined runtime, each realization can be simulated in a deterministic fashion.
\textbf{FIXME: il faut que tu m'expliques ça, je ne suis pas sûr de comprendre
déterministe.} 
