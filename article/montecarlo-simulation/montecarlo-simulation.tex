...
focuses on how the \ac{mcs} method, under some given variability assumptions, to
...
application.   The  input of  the  simulation  is a  set  of  $n$ \acp{rv}  each
...
When Simulating Montage the \ac{mcs} achieves a capture rate of 100\%.
