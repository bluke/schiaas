...
this   realisation   is   simulated    independently,   providing   a   makespan
sample.  Finally the  sample  are  aggregated in  the  final distribution.  This
approach enables  to sidestep intense  numerical resolution by  simply repeating
simpler deterministic simulations and have  realizations scheduled as they would
based on  their jobs runtimes  by having dynamical scheduling  integrated inside
the simulator. 
...
average of all observed runtimes, and $\mathcal{U}$ an uniform distribution.
...
application-strategy combination.  We obtain the  perturbation level by  averaging the
