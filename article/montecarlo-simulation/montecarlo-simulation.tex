...
Simulation has always being corner stone of the study of distributed systems.
Because large scale distributed systems are such a cost to setup and maintain,
organisation operating them would rather be used for computational purpose
rather than experiment on them functionally. Simulators allow research on
distributed systems without having to build a dedicated distributed system. Over
the last decade the rise of cloud computing as allowed for the appearance of
multiple simulator dedicated to \ac{iaas}.
...
simulations. Such \ac{des} based simulations require at least a platform
...
while changing the platform specification. Application description can vary
