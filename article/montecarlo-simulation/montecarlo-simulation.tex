...
different extents around the specified runtimes for the random variables. Let us
now describe the \ac{mcs} process itself.
...
... (FIXME: fitting necessary?). The second viewpoint 
  

  
\begin{itemize}
\item  The first  result regards  the  relationship between  the user  specified
...
In the method presented above, we establish
