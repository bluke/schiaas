...
composed of a number of potentially  dependent jobs it becomes quickly difficuly
...
%----------------------- prediction tools --------------------------------------
Independtly  of scheduling  decisions,  accurate prediction  of  the runtime  of
...
has been chosen as the simulation engine, for the versatility of its interfaces,
and    above   all,    for   its    well-studied   accuracy    against   reality
(e.g~\cite{StanisicTLVM15,VelhoSCL13}).
