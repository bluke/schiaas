...
execution traces observed in real executions~\cite{}.
%
...
\ac{pdf} and \ac{cdf}, where the \ac{cdf} is obtain by integrating the \ac{pfd}.
...
integrated inside the simulator. 
