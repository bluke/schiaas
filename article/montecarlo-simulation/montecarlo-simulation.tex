...
enough for the \ac{mcs} to predict over 90\% of real runs.
...
runtime in which the simulations effective  runtimes will be drawn. If we assume
...
\ac{MCS}. To that  end, we assume a  good guess for an estimated  runtime is the
