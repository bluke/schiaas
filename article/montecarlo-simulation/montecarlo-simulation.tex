...
extensive results provides by stochastic simulations. This approach garantees
...
$i  \in\,[1;n]$, the  user provides  a runtime  estimate $T_i$,  from which  the
system computes a \ac{rv} $R_i$ (to be explained below).
