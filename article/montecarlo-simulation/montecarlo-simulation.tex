...
amount  of computation  of communication  to perform,  from which  the simulator
computes the task duration based on the platform specification. An alternative
approach is predict the task duration from previous actual execution traces.

is the  series of
events happening during  the simulation. Although the application  is the active
