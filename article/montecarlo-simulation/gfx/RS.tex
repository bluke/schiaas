...
%%Sclouder
\node[b,fg,minimum width=3.5cm,minimum height=1.5cm](simschlouder)at(0,5.5){SimSchlouder};
\draw[-{latex},thick,](simschlouder.south-|cc.north)--(cc)node[pos=0.5,left]{provisioning};
