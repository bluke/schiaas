...
\begin{figure}
	...
	\caption[caption]{Makespan and \#BTU distributions for MCS compared to reality for P=10\%.%\\ 
...
\paragraph{Advantages and limitations of the enriched simulation.}\label{sec:lim}
