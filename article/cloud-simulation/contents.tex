...
making up SCHIaaS:
\begin{itemize}
\item The Core contains all the management code necessary to set up the data
  structures corresponding of the cloud described in the configuration file, and
  to reflect on the data structure the effects of all the operations triggered
  though the Compute and Storage engines.   
\item The Compute Engine provides an interface for the management of VMs. It
...
\item The Storage Engine offers an interface for the management of block
