...
\begin{figure}
  ...
  \includegraphics[width=\textwidth]{best-4metrics.pdf}
  
  \input{\vrpath best-4metrics.mmmm.latex}
...
\begin{figure}
  \includegraphics[width=\textwidth]{best-4metrics-platform-app.pdf}
...
\begin{itemize}
 \item openstack-icps / omssa (107 xp): 
      ...
      \input{\vrpath best-openstack-icps-omssa-4metrics.mmmm.latex}
...
\begin{figure}  
  \includegraphics[width=\textwidth]{best-openstack-icps-omssa-noschederror-4metrics.pdf}

  \input{\vrpath best-openstack-icps-omssa-noschederror-4metrics.mmmm.latex}
      
  \input{\vrpath best-openstack-icps-omssa-noschederror-4metrics.mmmm.cmp.latex}
...
\end{figure}       
 ...
 \item openstack-icps / montage (36 xps): 
      ...
      \input{\vrpath best-openstack-icps-montage-4metrics.mmmm.latex}

      \input{\vrpath best-openstack-icps-montage-4metrics.mmmm.cmp.latex}
 ...
 \item bonfire / omssa (75 xp): 
      ...
      \input{\vrpath best-bonfire-omssa-4metrics.mmmm.latex}
      
      \input{\vrpath best-bonfire-omssa-4metrics.mmmm.cmp.latex}
 ...
 \item bonfire / montage (56 xp): 
      ...
      \input{\vrpath best-bonfire-montage-4metrics.mmmm.latex}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{sim_no-boottimes-4metrics-compare.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{sim_no-threads-4metrics-compare.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{sim_communications-4metrics-compare.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{sim_predictions-4metrics-compare.pdf}
