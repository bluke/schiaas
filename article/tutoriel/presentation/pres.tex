...
\title[SCHIaaS]{\unistra{}Étude expérimentale par la simulation de clouds avec SCHIaaS}
...
\begin{frame}
	...
	SCHIaaS~\footfullcite{schiaas-gforge} est un \emph{framework} permettant
