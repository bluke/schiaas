...
qui  a   incité  les   chercheurs  à  proposer   des  modèles   qui  s'expriment
essentiellement  sous  la  forme  de  simulateurs. Ces simulateurs reposent sur
une modélisation qu'on peut qualifier de bottom-up : les ressources matérielles
sont d'abord modélisées, puis le comportement des machines virtuelles sur ces
ressources matérielles, 
  On  peut  citer  les  projets
CloudSim, EmuSim, ... Cependant, 
