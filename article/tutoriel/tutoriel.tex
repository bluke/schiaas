...
present available load injector
present lab cfg (verbatim cfg et command)
	explain sim seq 
	explain systematic log filtering
Show postprocessing with graphs
	all graphs are in pdf
