...
\author{Julien Gossa, Luke Bertot, Stéphane Genaud}% A voir l'ordre. 
...
résutats.
  ...
  \MotsCles{simulation ; cloud ; reproducibilité }
\end{abstract}
...
l'occurrence, il s'agit d'un template R, utilisant une librairie inclue dans le 
lab :
