...
plot(reconsolidator0.VirtualMachines__state_eq_migrating$date,reconsolidator0.VirtualMachines__state_eq_migrating$value, type="s")
dev.off()
png('migrations-reconsolidator10.png')
plot(reconsolidator10.VirtualMachines__state_eq_migrating$date,reconsolidator10.VirtualMachines__state_eq_migrating$value, type="s")
dev.off()
